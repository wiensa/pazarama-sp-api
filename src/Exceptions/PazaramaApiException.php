...
namespace PazaramaApi\PazaramaSpApi\Exceptions;

use Exception;
use Throwable;

class PazaramaApiException extends Exception
{
    /**
     * API hata kodu
     *
    ...
    /**
     * PazaramaApiException sınıfı yapıcı fonksiyonu
     *
    ...
    public function __construct(
        string $message = 'Pazarama API hatası',
        int $code = 500,
